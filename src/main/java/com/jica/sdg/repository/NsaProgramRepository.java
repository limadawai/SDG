...
public interface NsaProgramRepository extends CrudRepository<NsaProgram, Integer> {
	...
	@Query(value = "select a.* from nsa_program a left join ref_role b on a.id_role=b.id_role where a.id_monper = :id_monper and b.id_prov = :id_prov",nativeQuery = true)
