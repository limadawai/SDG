...
public interface SdgIndicatorRepository extends CrudRepository<SdgIndicator, Integer> {
	...
	@Query(value = "select a.id_indicator, a.id_goals, a.id_target, a.nm_indicator, b.nm_unit from sdg_indicator a Left Join ref_unit b on a.unit = b.id_unit where a.id_goals = :id_goals and a.id_target = :id_target",nativeQuery = true)
	public List findAllGrid(@Param("id_goals") String id_goals, @Param("id_target") String id_target);
}
