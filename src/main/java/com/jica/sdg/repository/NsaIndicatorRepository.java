...
public interface NsaIndicatorRepository extends CrudRepository<NsaIndicator, Integer> {
	...
	@Query(value = "select a.id, a.id_nsa_indicator,a.nm_indicator,b.id_unit,b.nm_unit,a.nm_indicator_eng,a.internal_code from nsa_indicator a left join ref_unit b on a.unit=b.id_unit where a.id_program = :id_program and a.id_activity = :id_activity",nativeQuery = true)
