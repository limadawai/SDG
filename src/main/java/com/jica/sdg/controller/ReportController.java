...
//            query.setParameter("tahun", tahun);
    ...
    //            query.setParameter("role", role);
                ...
                String sql  = "select z.id_role, z.nm_role, \n" +
                            ...
                            " '' as sumber,\n" +
                            "'JICA SDG' as pelaku,  \n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c1.realisasi_11 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c1.realisasi_12 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '3') = 0 ) then '' else c1.realisasi_13 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '4') = 0 ) then '' else c1.realisasi_14 end) ) as total_quarter1,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c2.realisasi_21 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c2.realisasi_22 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '3') = 0 ) then '' else c2.realisasi_23 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '4') = 0 ) then '' else c2.realisasi_24 end) ) as total_quarter2,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c3.realisasi_31 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c3.realisasi_32 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '3') = 0 ) then '' else c3.realisasi_33 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '4') = 0 ) then '' else c3.realisasi_34 end) ) as total_quarter3,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c4.realisasi_41 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c4.realisasi_42 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '3') = 0 ) then '' else c4.realisasi_43 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '4') = 0 ) then '' else c4.realisasi_44 end) ) as total_quarter4,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c5.realisasi_51 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c5.realisasi_52 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '3') = 0 ) then '' else c5.realisasi_53 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '4') = 0 ) then '' else c5.realisasi_54 end) ) as total_quarter5,\n" +
                        
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c1.realisasi_11 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+0)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c1.realisasi_12 end) ) as total_semester1,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c2.realisasi_21 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+1)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c2.realisasi_22 end) ) as total_semester2,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c3.realisasi_31 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+2)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c3.realisasi_32 end) ) as total_semester3,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c4.realisasi_41 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+3)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c4.realisasi_42 end) ) as total_semester4,\n" +
                            "((case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '1') = 0 ) then '' else c5.realisasi_51 end)+(case when ((select count(*) from entry_show_report where id_monper = :id_monper and year = '"+(tahun+4)+"' and type = 'entry_gov_budget' and period = '2') = 0 ) then '' else c5.realisasi_52 end) ) as total_semester5\n" +
